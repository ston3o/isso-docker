...
HASH256="$(wget -qO- http://docker:${PORT}/js/embed.min.js | openssl dgst -sha256 -binary | openssl base64 -A)"
HASH384="$(wget -qO- http://docker:${PORT}/js/embed.min.js | openssl dgst -sha384 -binary | openssl base64 -A)"
HASH512="$(wget -qO- http://docker:${PORT}/js/embed.min.js | openssl dgst -sha512 -binary | openssl base64 -A)"
